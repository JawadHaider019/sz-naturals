                                    ...
                                    {socialPlatforms.map((platform) => {
                                        ...
                                        return (
                                            <a
                                                ...
                                                className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 border border-gray-300 ${platform.color}`}
                                                aria-label={platform.label}
                                                title={isActive ? `Follow us on ${platform.label}` : `${platform.label} coming soon`}
                                                onClick={!isActive ? (e) => e.preventDefault() : undefined}
                                            >
                                                <FontAwesomeIcon icon={platform.icon} size="sm" className="text-sm sm:text-base" />
                                            </a>
                                        )
                                    })}
                                </div>
